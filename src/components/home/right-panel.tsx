...
const RightPanel = () => {
	...
	const conversationImg = selectedConversation.groupImage || selectedConversation.image
			...
			<div className='w-full sticky top-0 z-50'>
				...
				<div className='flex justify-between bg-gray-primary p-3'>
					<div className='flex gap-3 items-center'>
						<Avatar>
							<AvatarImage src={conversationImg || "/placeholder.png"} className='object-cover' />
							<AvatarFallback>
